...
function bootstrap {
    ...
    cd  "$SDK_DIR"
    export TONOMY_OPS_KEY=PVT_K1_24kG9VcMk3VkkgY4hh42X262AWV18YcPjBTd2Hox4YWoP8vRTU
    # Corresponding public key: PUB_K1_6VTUaL8u2S8g6z2FawT7RuyjVdCYD8mGXGy5iVcRpRWy5umj7q
    export TONOMY_BOARD_KEYS='{"keys":["PUB_K1_81aU18Y3RdyFf2WY4Wy7g7fvG9M9d7hmY4rhNFeXouYYPjExua","PUB_K1_5HWprCobEy8LiYUpfVmh8BdGDb8ANPc8rhBhtNqhvXnuxpyCaq","PUB_K1_5VLYVhqfe7oh8TW2i6Nw251wbpoZ4p15DV7udqDjiaKnryx9YU"]}'
