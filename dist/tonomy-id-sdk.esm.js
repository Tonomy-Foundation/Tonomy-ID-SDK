...
import { decodeJWT, ES256KSigner } from '@tonomy/did-jwt';
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            // };
            resolver = new Resolver(_extends({}, getResolver({
              antelopeChainUrl: settings.blockchainUrl,
              fetch: fetch
            })));
            _context2.prev = 3;
            _context2.next = 6;
            return Promise.any([verifyCredential(this.jwt, {
        ...
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            if (keyManagerLevel === void 0) {
              keyManagerLevel = KeyManagerLevel.BROWSER_LOCAL_STORAGE;
            }
            _context4.next = 3;
          ...
          case 3:
            ...
            throw throwError('key not found', SdkErrors.KeyNotFound);
          case 6:
            _context4.next = 8;
          ...
          case 2:
            ...
            return new Promise(function (resolve, reject) {
              ...
              setTimeout(function () {
                ...
                reject(createSdkError('Could not connect to Tonomy Communication server', SdkErrors.CommunicationNotConnected));
              }, 5000);
            });
          case 6:
          case "end":
        ...
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return new Promise(function (resolve, reject) {
              ...
              setTimeout(function () {
                reject(createSdkError('Connection timed out to Tonomy Communication server', SdkErrors.CommunicationTimeout));
              }, 5000);
            });
          case 2:
            return _context2.abrupt("return", _context2.sent);
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 9:
            ...
            if (_context5.t0 instanceof SdkError && _context5.t0.code === SdkErrors.UsernameNotFound) {
              _context5.next = 13;
              break;
            }
            throw _context5.t0;
        ...
        while (1) switch (_context15.prev = _context15.next) {
          ...
          case 22:
            ...
            if (!localKey && blockchainPermission) {
              ...
              throwError(pair.level + " key was not found in the keyManager, but was found on the blockchain", SdkErrors.KeyNotFound);
            }
            if (localKey && !blockchainPermission) {
              // User probably hasn't finished create account flow yet
              throwError(pair.level + " keys was not found on the blockchain, but was found in the keyManager", SdkErrors.KeyNotFound);
            }
      ...
      return _regeneratorRuntime().wrap(function _callee17$(_context17) {
        while (1) switch (_context17.prev = _context17.next) {
          ...
          case 2:
            ...
            _context17.t1 = UserStatus.READY;
    ...
    var _signMessage = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee19(payload, recipient) {
      ...
      return _regeneratorRuntime().wrap(function _callee19$(_context19) {
        while (1) switch (_context19.prev = _context19.next) {
          case 0:
            signer = createVCSigner(this.keyManager, KeyManagerLevel.LOCAL);
            _context19.next = 3;
            return this.getDid();
          case 3:
      ...
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          ...
          case 3:
            ...
            throw throwError('No Key Found for this level', SdkErrors.KeyNotFound);
          case 6:
      ...
      return _regeneratorRuntime().wrap(function _callee11$(_context11) {
        while (1) switch (_context11.prev = _context11.next) {
          ...
          case 24:
            ...
            _context11.next = 28;
            return externalUser.setAccountName(Name.from(accountName));
          case 28:
            _context11.next = 30;
...
export { AccountType, App, AppStatus, Authority, BrowserStorage, Communication, EosioContract, EosioTokenContract, EosioUtil, ExternalUser, HttpError, IDContract, KeyManagerLevel, Message, SdkError, SdkErrors, TonomyUsername, User, UserApps, UserStatus, browserStorageFactory, createSdkError, createStorage, createUserObject, createVCSigner, decodeHex, encodeHex, generateRandomKeyPair, getSettings, int2hex, randomBytes, randomString, setSettings, sha256, storageProxyHandler, throwError, toElliptic };
